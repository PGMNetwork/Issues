...
This is a public issue-tracking repository for bugs and confirmed features related to the PGM Network.

### Important:

If you find a potential exploit or vulnerability, please exercise reasonable disclosure:

1. Privately [contact PGM Network staff](mailto:support@pgmnetwork.pl?subject=Important%20security%20vulnerability) about the issue.
2. **Do not** publicly disclose the issue immediately (give PGM Network staff adequate time to respond to and address your inquiry before you disclose the vulnerability publicly).

## Submitting

Issues can be [submitted](https://github.com/PGMNetwork/Issues/issues/new) at the [issue tracker](https://github.com/PGMNetwork/Issues/issues).
